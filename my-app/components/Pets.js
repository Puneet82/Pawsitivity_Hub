...
const pets = [
  { id: 1, category: 'dog', name: 'Golden Retriever', image: Pet1Img },
  { id: 2, category: 'dog', name: 'German Shepherd', image: Pet2Img },
  { id: 3, category: 'dog', name: 'Labrador Retriever', image: Pet3Img },
  { id: 4, category: 'dog', name: 'Bulldog', image: Pet4Img },
  { id: 5, category: 'dog', name: 'Poodle', image: Pet5Img },
  { id: 6, category: 'dog', name: 'Beagle', image: Pet6Img },
  { id: 7, category: 'dog', name: 'Rottweiler', image: Pet7Img },
  { id: 8, category: 'dog', name: 'Siberian Husky', image: Pet8Img },
  { id: 9, category: 'dog', name: 'Dachshund', image: Pet9Img },
  { id: 10, category: 'dog', name: 'Boxer', image: Pet10Img },
  { id: 11, category: 'dog', name: 'Doberman', image: Pet11Img },
  { id: 12, category: 'dog', name: 'Chihuahua', image: Pet12Img },
];
          ...
          <div className='relative lg:w-[60%] bg-[#F79D5C]/40 flex-1 flex items-center'>
            <div className='flex flex-wrap gap-4 justify-center lg:justify-end lg:mr-6'>
              {pets.map((pet, index) => (
                ...
                >
                  {/* overlay */}
                  <div className={`bg-black/40 w-full h-full absolute rounded-full ${petIndex === index ? 'border-2 border-white' : ''}`}></div>
                  <Image
                    src={pet.image}
                    width={95}
                    height={95}
